                        ...
                        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 relative z-10">
                            ...
                            <div className="flex flex-col sm:flex-row items-center gap-8 bg-black/5 p-4 rounded-[40px] backdrop-blur-sm border border-white/5">
                                <div className="flex -space-x-4">
                                    ...
                                    <div className="w-14 h-14 rounded-full border-4 border-[#638C7D] bg-brand-secondary flex items-center justify-center text-white font-black text-sm z-10 relative shadow-xl">
                                        +5k
                                    </div>
                                </div>
