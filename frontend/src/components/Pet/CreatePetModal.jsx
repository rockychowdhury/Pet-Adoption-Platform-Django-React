...
const CreatePetModal = ({ isOpen, onClose, onSuccess }) => {
    const api = useAPI();
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} title="List a New Pet">
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input
                            ...
                            className="w-full px-4 py-2 rounded-xl border border-gray-200 focus:border-action focus:ring-2 focus:ring-action/20 outline-none transition"
                            placeholder="e.g. Max"
                        />
                    </div>
                    <div>
